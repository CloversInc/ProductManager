...
namespace ProductManager.Web.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            kernel.Bind<IProductManagerDbContext>().To<ProductManagerDbContext>();
            kernel.Bind<IProductManagerData>().To<ProductManagerData>();

            kernel.Bind<IProductService>().To<ProductService>();
            //kernel.Bind<IStorageService>().To<StorageServices>();
